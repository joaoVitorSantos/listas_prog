...
def dias_para_segundos(dias,horas,minutos,segundos):
    ...
    a data em segundos'''
    conversor_dias = dias * 86400
    conversor_horas = horas * 3600
    conversor_minutos = minutos * 60

    soma_segundos = conversor_dias + conversor_horas + conversor_minutos + segundos
...
def preco_aluguel_carro(dias,km):
    ...
    preco_dia = dias * 60.00
    preco_km = km * 0.15

    valor = preco_dia + preco_km
    return valor
...
def dias_perdidos_por_fumar(cigarros,anos):
    ...
    minutos_perdidos = (10 * cigarros) * (365 * anos)
